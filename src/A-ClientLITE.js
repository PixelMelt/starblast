...
(function() {
    ...
    if (window.location.pathname == "/") {
      ...
      function themeclient() {
        if (document.getElementById("logo").innerHTML != '<img src="https://cdn.upload.systems/uploads/ngqIvMj0.png">') {
          document.getElementById("logo").innerHTML = '<img src="https://cdn.upload.systems/uploads/ngqIvMj0.png">'
        }
